 ...
 * 저장처리화면
 ******************************************************** */
function fn_egov_regist_exam(form){
	...
	*/
	...
	if (!validateExamVO(form)) {
		...
		form.action = "<c:url value='/exam/ExamRegist.do'/>";
		form.submit();
    ...
    <div id="bodywrap">
 		<div id="content_field"><!--contents start-->
            ...
            <div class="search_service">
                <div class="search_top_table">                  
					...
					<caption>exam내용등록</caption>
					  <tr> 
					    <td class="td_width"><label>제목</label><img src="<c:url value='/images/required.gif'/>" width="15" height="15" alt="필수항목"></td>
					    <td class="td_content">
            ...
            <div class="buttons" align="center" style="margin-bottom:100px">
                 ...
                 <a href="<c:url value='/exam/ExamView.do?pageIndex=${searchVO.pageIndex }'/>" onclick="fn_egov_examview_examlist(<c:out value='${searchVO.pageIndex }'/>); return false;"><spring:message code="button.list" /></a>
            </div>
            </td></tr></table>
            <!-- 목록/저장버튼  끝-->
